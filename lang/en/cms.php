...
$string['course:displayname'] = 'Course info';
$string['course:sample:fullname'] = 'Example Course';
$string['course:sample:shortname'] = 'EXAMPLE101';
$string['course:sample:summary'] = 'An example course summary.';
